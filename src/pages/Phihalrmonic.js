      ...
      <Container className="size-container">
        <Row className='row-rast'>
         ...
         <Col className='row-col2'>
           ...
           <p>Тольяттинская филармония это “дом музыки” в Тольятти, каждый год именно в этом месте раскрывается красота искусства  для более сотни тысяч граждан. Проходящие здесь выступления опьяняют слушателей и зрителей, куда мы вас и приглашаем(предлагаем посетить).
</p>

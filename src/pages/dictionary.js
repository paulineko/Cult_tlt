  ...
  <Container className="s-container">
        ...
        <Container className="s3-container">
          <Row className='row-rast'>
           ...
           <Col className='r-col3'>
           <h1>Дб</h1>
            <p>Дб на тольяттинском сленге- Дворец бракосочетания. Под аббревиатурой подразумевается крыша здания, ставшая излюбленным местом тусовок сразу несколько поколений молодежи</p>
           </Col>
          </Row>
        ...
        <Container className="s-container">
          <Row className='row-rast'>
           ...
           <Col className='r-col3'>
           <h1>Изолента</h1>
            <p>Здание генеральной дирекции АВТОВАЗ. Высотка характерного голубого цвета, на вершине которой крутится огромная ладья - логотип бренда Lada</p>
           </Col>
          </Row>
        ...
        <Container className="s2-container">
          <Row className='row-rast'>
           ...
           <Col className='r-col3'>
           <h1>Карман</h1>
            <p>Карман- проезд, идущий с дороги, который обычно ведет внутрь жилого квартала. Из-за того, что Автозаводский район проектировался жилыми кварталами, появилась целая сеть карманов, нужная для удобства попадания в тот или иной дом</p>
           </Col>
          </Row>
        ...
        <Container className="s4-container">
          <Row className='row-rast'>
           ...
           <Col className='r-col3'>
           <h1>Новый город</h1>
            <p>После того, как начали строить Автозаводский район, название Новый город перекочевало к нему</p>
           </Col>
          </Row>
        ...
        <Container className="s-container">
          <Row className='row-rast'>
           ...
           <Col className='r-col3'>
           <h1>Петушок</h1>
            <p>Торговый центр в 7 квартале, в народе раньше назывался петушок из-за находящегося в нем кафе "Золотой петушок"</p>
           </Col>
          </Row>
        ...
        <Container className="s-container">
          <Row className='row-rast'>
           ...
           <Col className='r-col3'>
           <h1>ПП</h1>
            <p>ПП- Парк Победы. На лавочках центральной аллеи любили собираться молодые, а лестницы и парапеты у Вечного огня облюбовали скейтеры и другие экстремалы</p>
           </Col>
          </Row>
        ...
        <Container className="s2-container">
          <Row className='row-rast'>
           ...
           <Col className='r-col3'>
           <h1>Свечка</h1>
            <p>Свечка- это памятник героям Великой Отечественной Войны на Площади Свободы в Центральном районе Тольятти. На парапетах обелиска, который по форме напоминает свечу, любят кататься скейтеры.</p>
           </Col>
          </Row>
        ...
        <Container className="s4-container">
          <Row className='row-rast'>
           ...
           <Col className='r-col3'>
           <h1>Шлюз</h1>
            <p>Шлюзовой район. Маленький район в стиле сталинского ампира распологается прямо около ГЭС, за это его называют Маленьким Петербургом</p>
           </Col>
          </Row>
        ...
        <Container className="s4-container">
          <Row className='row-rast'>
           ...
           <Col className='r-col3'>
           <h1>Шоколадка</h1>
            <p>Научно-Технический Центр АВТОВАЗ. Представляет собой большое конструктивистское здание шоколадного цвета. В купе панельной отделкой создает ассоциации к плитке шоколада</p>
           </Col>
          </Row>
